...
export default function CadastroAdm() {
  ...
  const [imagem, setImagem] = useState(null); // 👈 voltou o estado da imagem

  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IktheWt5IiwiZW1haWwiOiJrYXlreW5hc2NpbWVudG9lcEBnbWFpbC5jb20iLCJyb2xlIjoiVXN1YXJpbyIsIm5iZiI6MTc2MTgzMzk3OCwiZXhwIjoxNzYxODM3NTc4LCJpYXQiOjE3NjE4MzM5NzgsImlzcyI6Ik5leHVzQVBJIiwiYXVkIjoiTmV4dXNBUElVc3VhcmlvcyJ9.64bPz8MXdggl5RNi2Qi8_z1CyTta5wXjl_x35upfr7I";
  ...
  const handleSubmit = async (e) => {
    ...
    const cargoSelecionadoNome =
      cargos.find((c) => c.idTipoFuncionario === cargoSelecionado)
        ?.tipoDeFuncionario || "";
    ...
    try {
      ...
      // 2) Busca o funcionário pelo e-mail pra pegar o id
      const buscarRes = await fetch(
        `https://localhost:7079/api/Funcionarios/buscar?email=${email}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      ...
      // 3) Se tiver imagem, faz o upload com o id retornado
          ...
          <form className="form-grid" onSubmit={handleSubmit}>
            ...
            <div className="field">
              ...
              >
                ...
                {cargos.map((c) => (
                  <option
                    key={c.idTipoFuncionario}
                    value={c.idTipoFuncionario}
                  >
                    {c.tipoDeFuncionario}
                  </option>
                ))}
