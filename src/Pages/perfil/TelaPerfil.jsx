...
// import "../../Pages/perfil/telaperfil.css";
// import ImagemPerfil from "../../assets/img/Ícones/vectorCadastrar.svg"
...
//             <div className="BolinhaFoto"><button className="botaoperfil"><img src={ImagemPerfil} alt="" className="imagemperfiiil"/></button></div>
//             <h2 className="FotoPerfil">Foto de Perfil</h2>
//             <div className="Informações">
//               <div className="Quadrado"><h1 className="h1dequadrado">Fulano Silva</h1></div>
//               <div className="Quadrado"><h1 className="h1dequadrado">27 Anos</h1></div>
//               <div className="Quadradoinf"><h1 className="h1dequadrado">Fulanodasilva@gmail.com</h1></div>
//               <div className="Quadradoinf"><h1 className="h1dequadrado">Analise de Marketing</h1></div>
//               <div className="QuadradoULT"><h1 className="h1dequadrado">Marketing</h1></div>
//             </div>
//             {/* </div> */}
//         </div>
//       </main>
